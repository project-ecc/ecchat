...
#			return
	...
	def cryptoInitialise(self):
		...
		respond_id = int(time.time()) % 32768 + 32768

		logging.info('Autogenerated response id {}'.format(respond_id))

		if loadConfigurationECC(self.coins, eccPacket._protocol_id_ecchat, respond_id) and loadConfigurationAlt(self.coins, self.conf):
...
def main():
	...
	argparser.add_argument('-n', '--name'  , action='store',      help='chat name'          , type=str, default = ''           , required=True )
